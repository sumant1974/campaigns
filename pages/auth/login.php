...
<html>
<head>
	<title>Eduskills Certificate Management Portal</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form method="POST" class="login100-form validate-form" action="login.php">
					...
					if($loginfailure==1)
					{?>
						<div id="errmsg" class='text-red text-center p-t-12'>"Login Failed, Please check your username/password and try again"</div>
					<?php }
