...
class Spoc
{
    ...
    public function getSpocs()
    {
        if(isset($_SESSION["jwt"]))
        {
            ...
            $url="https://eduskillsfoundation.org/mpartners/api/spocs/getispocs.php";
    ...
    public function create()
    {
        ...
        {
            $this->jwt=$_SESSION["jwt"];
            $url="https://eduskillsfoundation.org/mpartners/api/spocs/create.php";
    ...
    public function update()
    {
        ...
        {
            $this->jwt=$_SESSION["jwt"];
            $url="https://eduskillsfoundation.org/mpartners/api/spocs/update.php";
    ...
    public function delete()
    {
        ...
        {
            $this->jwt=$_SESSION["jwt"];
            $url="https://eduskillsfoundation.org/mpartners/api/spocs/delete.php";
