...
function create(){
    ...
    $this->mobile=htmlspecialchars(strip_tags($this->user_recovery_mobile));
    ...
    $password_hash = md5($this->user_pass);
...
// echo $this->user_id;
 ...
 //echo $num;
    ...
    if($num>0){
        ...
        $this->user_recovery_mobile = $row['mobile'];
		$this->user_pass = $row['password'];
		$this->alternate_email = $row['emailid'];
