...
class Institute
{
    ...
    public function getaDashboard()
    {
        if(isset($_SESSION["jwt"]))
        {
            ...
            $url="https://eduskillsfoundation.org/mpartners/api/institutes/getadashboard.php";
    ...
    public function create()
    {
        ...
        {
            $this->jwt=$_SESSION["jwt"];
            $url="https://eduskillsfoundation.org/mpartners/api/institutes/create.php";
    ...
    public function update()
    {
        ...
        {
            $this->jwt=$_SESSION["jwt"];
            $url="https://eduskillsfoundation.org/mpartners/api/institutes/update.php";
    ...
    public function delete()
    {
        ...
        {
            $this->jwt=$_SESSION["jwt"];
            $url="https://eduskillsfoundation.org/mpartners/api/institutes/delete.php";
