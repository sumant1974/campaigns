...
class Course
{
    ...
    public function getDashboard()
    {
        if(isset($_SESSION["jwt"]))
        {
            ...
            $url="https://eduskillsfoundation.org/mpartners/api/pcourses/getdashboard.php";
    ...
    public function getPCourses()
    {
        ...
        {
            $this->jwt=$_SESSION["jwt"];
            $url="https://eduskillsfoundation.org/mpartners/api/pcourses/getpcourses.php";
    ...
    public function getAllCourses()
    {
        ...
        {
            $this->jwt=$_SESSION["jwt"];
            $url="https://eduskillsfoundation.org/mpartners/api/pcourses/getallcourses.php";
        $data=array("jwt"=>$this->jwt);
        //echo $url.$data['user_id'];
        $result=$this->callAPI($url,json_encode($data));
       /* curl_setopt($curl, CURLOPT_POST, 1);
    ...
    public function create()
    {
        ...
        {
            $this->jwt=$_SESSION["jwt"];
            $url="https://eduskillsfoundation.org/mpartners/api/pcourses/create.php";
    ...
    public function update()
    {
        ...
        {
            $this->jwt=$_SESSION["jwt"];
            $url="https://eduskillsfoundation.org/mpartners/api/pcourses/update.php";
    ...
    public function delete()
    {
        ...
        {
            $this->jwt=$_SESSION["jwt"];
            $url="https://eduskillsfoundation.org/mpartners/api/pcourses/delete.php";
