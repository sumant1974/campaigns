...
class Partner
{
    ...
    public function getDashboard()
    {
        if(isset($_SESSION["jwt"]))
        {
            ...
            $url="https://eduskillsfoundation.org/mpartners/api/partners/getdashboard.php";
    ...
    public function create()
    {
        ...
        {
            $this->jwt=$_SESSION["jwt"];
            $url="https://eduskillsfoundation.org/mpartners/api/partners/create.php";
    ...
    public function update()
    {
        ...
        {
            $this->jwt=$_SESSION["jwt"];
            $url="https://eduskillsfoundation.org/mpartners/api/partners/update.php";
    ...
    public function delete()
    {
        ...
        {
            $this->jwt=$_SESSION["jwt"];
            $url="https://eduskillsfoundation.org/mpartners/api/partners/delete.php";
