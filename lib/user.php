...
class User
{
    ...
    public function getUsers()
    {
        if(isset($_SESSION["jwt"]))
        {
            ...
            $url="https://eduskillsfoundation.org/mpartners/api/users/getusers.php";
    ...
    public function create()
    {
        ...
        {
            $this->jwt=$_SESSION["jwt"];
            $url="https://eduskillsfoundation.org/mpartners/api/users/create.php";
    ...
    public function update()
    {
        ...
        {
            $this->jwt=$_SESSION["jwt"];
            $url="https://eduskillsfoundation.org/mpartners/api/users/update.php";
    ...
    public function delete()
    {
        ...
        {
            $this->jwt=$_SESSION["jwt"];
            $url="https://eduskillsfoundation.org/mpartners/api/users/delete.php";
